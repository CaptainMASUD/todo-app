...
import { Search, Filter, ChevronDown, MoreHorizontal, Edit, Trash, Eye, ArrowUpDown, CheckCircle, XCircle } from 'lucide-react'
...
const AllProductsPage = () => {
  ...
  // Sample product data
  const products = [
    { id: 1, name: "Wireless Earbuds", category: "Electronics", price: 129.99, stock: 45, status: "Active" },
    { id: 2, name: "Smart Watch", category: "Electronics", price: 199.99, stock: 32, status: "Active" },
    { id: 3, name: "Bluetooth Speaker", category: "Electronics", price: 89.99, stock: 18, status: "Active" },
    { id: 4, name: "Laptop Sleeve", category: "Accessories", price: 29.99, stock: 56, status: "Active" },
    { id: 5, name: "Phone Case", category: "Accessories", price: 19.99, stock: 78, status: "Active" },
    { id: 6, name: "Wireless Charger", category: "Electronics", price: 49.99, stock: 23, status: "Active" },
    { id: 7, name: "Fitness Tracker", category: "Electronics", price: 79.99, stock: 0, status: "Out of Stock" },
    { id: 8, name: "Desk Lamp", category: "Home", price: 39.99, stock: 12, status: "Active" },
    { id: 9, name: "Keyboard", category: "Electronics", price: 59.99, stock: 5, status: "Low Stock" },
    { id: 10, name: "Mouse", category: "Electronics", price: 24.99, stock: 0, status: "Discontinued" },
  ]
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                <th className="px-4 py-3 bg-gray-50 text-left">
